...
namespace Models
{
    ...
    {
        public static GameObject CreateNewCelestialBodyGameObject(string name, CelestialBody.CelestialBodyType type,
            Vector3 position, float mass, float diameter, Vector3 velocity)
        {
            // Validate name
